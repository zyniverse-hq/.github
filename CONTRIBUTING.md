# Contributing to Zyniverse Projects

Thank you for contributing to a Zyniverse HQ project! This guide covers our standards for all repositories under the [zyniverse-hq](https://github.com/zyniverse-hq) organization.
...
- No unnecessary `console.log` statements or commented-out code
- Tests pass (where applicable)
- Environment variables are documented in `.env.example`

---

*This guide applies to all repositories under the Zyniverse HQ organization.*
