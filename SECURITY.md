...
### For Zyniverse Team Members

If you discover a security vulnerability in any Zyniverse project, use the private reporting channel appropriate to the project type:

**Client Projects**
- Notify the project lead immediately via the team's communication channel
...
- Or contact the engineering lead directly
...
## Security Best Practices for Zyniverse Repositories
...
_This policy applies to all repositories under the Zyniverse HQ organization._
